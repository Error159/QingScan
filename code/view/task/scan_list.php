{include file='public/head' /}
    <div class="col-md-12 ">
        <div class="row tuchu">
            ...
            <div class="col-md-2">
                <a href="/index.php?s=task/add_task" class="btn btn-success">添加任务</a>
                <a href="/index.php?s=task/add_api_url" class="btn btn-success">添加API任务</a>
            </div>
        </div>
        <div class="row tuchu">
                ...
                <table class="table table-bordered table-hover table-striped">
                    ...
                    <?php foreach ($list as $value) { ?>
                        <tr>
                            ...
                            <td>
                                <a id="starScan" href="#" class="btn btn-sm btn-success">开始扫描</a>
