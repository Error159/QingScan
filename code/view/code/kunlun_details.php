            ...
            <div class="row" style="margin-bottom: 20px;">
                <div class="col-md-12">
                    <div class="pull-right" style="line-height: 36px;">
                        ...
                        <?php }?>
                        <span class="follow-vul j-follow-vul ">
                          <a href="<?php echo url('code/kunlun_list') ?>" class="btn btn-primary">返回列表页</a>
                        </span>
                        <span class="follow-vul j-follow-vul ">
                    ...
                    <section class="vul-basic-info" id="j-vul-basic-info">
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <dl>
                                    <dt>审核状态：</dt>
                                    <dd ><select  class="changCheckStatus form-control" style="padding: 0px 12px;height:22px;" data-id="<?php echo $info['id'] ?>">
