    ...
    <div class="row">
        ...
        <div class="col-md-3 ">
            <div class=" row tuchu">
                ...
                <a class="btn btn-success" href="/index.php?s=code_check/bug_detail&id=<?php echo $base['id'] + 1 ?>">下一个</a>
                <a class="btn btn-info" href="/index.php?s=code_check/bug_detail&id=<?php echo $base['id'] - 1 ?>">上一个</a>
            </div>
            <div class=" row tuchu">
