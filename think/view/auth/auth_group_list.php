...
<div class="col-md-12 ">
    <div class="row tuchu">
        ...
        <div class="col-md-2">
            <a href="<?php echo url('auth/authGroupAdd')?>" class="btn btn-success">添加用户组</a>
        </div>
    </div>
    <div class="row tuchu">
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="<?php echo url('auth/authGroupAccess',['auth_group_id'=>$value['auth_group_id']])?>"
                               class="btn btn-sm btn-primary">分配权限</a>
                            <a href="<?php echo url('auth/authGroupEdit',['auth_group_id'=>$value['auth_group_id']])?>"
                               class="btn btn-sm btn-primary">编辑</a>
                            <a href="<?php echo url('auth/authGroupDel',['auth_group_id'=>$value['auth_group_id']])?>" class="btn btn-sm btn-danger">删除</a>
                        </td>
                    </tr>
                <?php } ?>
            </table>
